...
/**
 * Controle (owner) pra compartilhar a ficha com o mestre. Gera um link
 * read-only revogavel (`/share/<token>`) — quem abrir ve a ficha sem conta e
 * sem poder editar. Modelo de um unico link ativo por ficha: revogar + gerar de
 * novo rotaciona o token.
 */
  ...
  return (
    <>
      ...
      >
        <Stack gap="md">
          <Text variant="muted">
            Gere um link pra qualquer pessoa ver esta ficha em modo somente leitura — sem precisar
            de conta e sem poder editar. Ideal pra mandar pro mestre.
          </Text>
